...
export default function App () {
    ...
    const contacts = [email, phoneNumber, website, location];
    ...
    return (
        <div className="container-xxl p-1">
            ...
            <p className="mb-4">To save your CV you can use screenshot tools. This is a beta version of the application, so PDF generator is not built in yet :\</p>
            <div className="row">
                ...
                <div className="col-md-7" id="preview">
                  <div className="container-fluid p-3 border border-1">
                    <div className="row">
                      {headshot && <div className="col-3">
                        <img src={headshot} alt="" className="img-fluid" />
                      </div>}
                      <div className="col text-center">
                        <h5 className="display-5 fw-bold">{name}</h5>
                        <h6 className="display-6">{specialty}</h6>
                        <p>{contacts.map(c => {
                          const filtered = contacts.filter(c => c.length > 0);
                    ...
                    <div className="row">
                      <div className="col-4 pe-3" id="left-bottom-section">
                        {courses.length > 0 && <figure className="my-3">
            ...
            <footer class="text-center mt-3"><p>©2024 by Yisroel Steiner</p></footer>
        </div>
    );
}